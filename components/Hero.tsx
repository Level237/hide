...
<section className="relative">
                <div className="relative z-10 max-w-screen-xl mx-auto px-4 py-28 md:px-8">
                    <div className="space-y-5 max-w-4xl mx-auto text-center">
                        ...
                        Where words meet hearts: Write your life, connect with souls.
                        </h2>
                        ...
                        <form
                            ...
                            />
                            <button className="flex bg-primary items-center justify-center gap-x-2 py-2.5 px-4 mt-3 w-full text-sm text-white font-medium duration-150 rounded-lg sm:mt-0 sm:w-auto">
                                Get started
                ...
                <div className="absolute inset-0 m-auto max-w-xs h-[357px] blur-[118px] sm:max-w-md md:max-w-lg" style={{ background: "linear-gradient(106.89deg, rgba(22, 163, 74, 0.11) 15.73%, rgba(22, 163, 74, 0.41) 15.74%, rgba(22, 163, 74, 0.1) 56.49%, rgba(22, 163, 74, 0.4) 115.91%)" }}></div>
            </section>
    </div>
  )
}
