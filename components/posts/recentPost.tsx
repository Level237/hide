  ...
  return (
    ...
    <div className=" max-h-56 p-3 px-8 rounded-2xl " style={{ background:"linear-gradient(to top left,#000000,#434343)" }}>
        ...
        <Avatar className='cursor-pointer w-9 h-9'>
            ...
            <div className="flex flex-col">
              <h2 className="font-bold text-sm " style={{ color:"white" }}>#uizog234</h2>
              <span className="text-[0.7rem] text-gray-500 text-primary">1h ago</span>
            </div>
        </div>
        <div className="mt-5">
          <h2 className="text-md font-bold" style={{ color:"white" }}>-How create post in Hide ,Please..I have forget that...</h2>
        </div>
    ...
    <div className=" max-h-56 p-3 px-8 rounded-2xl " style={{ background:"linear-gradient(to top left,#fcc5e4,#fda34b,#ff7882,#c8699e,#7046aa,#0c1db8,#020f75)" }}>
        ...
        <Avatar className='cursor-pointer w-9 h-9'>
            ...
            <div className="flex flex-col">
              <h2 className="font-bold text-sm " style={{ color:"white" }}>#uizog234</h2>
              <span className="text-[0.7rem] text-gray-500 text-primary">3h ago</span>
            </div>
        </div>
        <div className="mt-5">
          <h2 className="text-md font-bold" style={{ color:"white" }}>-Hello i like this social media.it{`'`} very beautiful post...</h2>
        </div>
        <div className='flex  justify-between text-white mt-5'>
          <div className='flex items-center gap-1'>
    ...
    <div className=" max-h-56 p-3 px-8 rounded-2xl " style={{ background:"linear-gradient(to top left,#40E0D0,#FF8C00,#FF0080)" }}>
        ...
        <Avatar className='cursor-pointer w-9 h-9'>
            ...
            <div className="flex flex-col">
              <h2 className="font-bold text-sm " style={{ color:"white" }}>#ehjyyzt45</h2>
              <span className="text-[0.7rem] text-gray-500 text-primary">3h ago</span>
            </div>
        </div>
        <div className="mt-5">
          <h2 className="text-md font-bold" style={{ color:"white" }}>-how create a voice in my post..i don{`'`}t know how create..</h2>
        </div>
        <div className='flex  justify-between text-white mt-5'>
          <div className='flex items-center gap-1'>
